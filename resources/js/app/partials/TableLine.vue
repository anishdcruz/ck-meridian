<template>
  <div class="select-form">
    <div class="select-input-2 line-item-select" :tabindex="disabled ? -1 : tabindex" ref="toggle" :disabled="disabled"
    ...
    <div class="select-table-dropdown" style="width: 800px;" v-if="showDropdown">
