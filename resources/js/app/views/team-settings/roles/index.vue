<template>
	<div class="content-inner">
		<x-filterable :exportable="false" :saved-filters="false"
			...
			<div slot="extra">
				<router-link to="/team-settings/roles/create" class="btn btn-primary">
			...
			<x-tr slot-scope="{ item }" @click.native="$router.push(`/team-settings/roles/${item.id}`)">
			    <x-td>{{item.name}}</x-td>
