...
class ContactsExport implements FromCollection, WithMapping, WithHeadings, ShouldAutoSize
{
	protected $team;
    ...
    public function map($contact): array
    {
        return [
            ...
            formatMoney($contact->total_revenue, false),
    ...
    {
    	if($this->filter) {
    		return Contact::serverExport($this->filter);
    	}
